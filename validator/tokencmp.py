...
# Token should be equal one-by-one
# separator can be \t, \n, \r, space
# If valid, function returns true, otherwise, it returns false
# EXAMPLE validator_tokencmp.validator("","2\t3","2  3") returns true
# EXAMPLE validator_tokencmp.validator("","2 3","2 03") returns false
# EXAMPLE validator_tokencmp.validator("","2 3 4","2 4 3") returns false

class validator_tokencmp:
	@staticmethod
